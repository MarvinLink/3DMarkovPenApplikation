...
#pragma warning restore CS0649
        ...
        protected virtual SplineMesh MakeSplineMesh(int interpolationSteps, Vector3 lineDiameter) {
            return new SplineMesh(new KochanekBartelsSpline(_smoothness, interpolationSteps), lineDiameter);
        }
        ...
        public void SetSmoohtness(int smoothness)
        {
            _smoothness = smoothness;
            SplineMesh.SetSmoothness(smoothness);
        }
